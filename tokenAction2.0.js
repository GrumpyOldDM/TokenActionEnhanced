// Forked from TokenAction 0.2.4 - https://github.com/git-kor-av/TokenAction by Kevin - https://app.roll20.netusers/399372/kevin
		...
		if (msg.type === 'api' && msg.content.search(/^!ta\b/) !== -1 && msg.selected) {
			...
			_.each(char, function(a) {
			    if (isNpc(a.id) === "1") {
			        ...
			        // This appears to have issues atm, disabled because I don't use it for PCs just NPCs
					//createSpell(a.id);
			    }
